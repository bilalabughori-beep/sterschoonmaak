...
function PublicAuthModal({ onClose }: { onClose: () => void }) {
  ...
  const changeMode = (next: AuthMode) => { setMode(next); setError(null); setMessage(null); setPassword(""); setConfirmation(""); };

...
export type CustomerComplaint = { id: string; reference: string; created_at: string; subject: string; message: string; status: "new" | "in_progress" | "resolved" | "closed"; locale: string; email_status?: "pending" | "sent" | "failed" };
